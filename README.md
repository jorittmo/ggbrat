...
![](man/figures/surface_strutctures.png)

Example of four view angles rendered to 2D:

<table>
  <tr>
    <td><img src="man/figures/selec1.png" width="100%" alt="First selected cortical camera angle"></td>
    <td><img src="man/figures/selec2.png" width="100%" alt="Second selected cortical camera angle"></td>
    <td><img src="man/figures/selec3.png" width="100%" alt="Third selected cortical camera angle"></td>
    <td><img src="man/figures/selec4.png" width="100%" alt="Fourth selected cortical camera angle"></td>
  </tr>
</table>

![](man/figures/view_points2.png)

The package supports many atlases and file types. As long as you have a surface (or volume) with corresponding labels (FreeSurfer, GIFTI, or `.vtp` meshes), you can kind of build from whatever you want. For example, here is a surface rendering of the medial temporal lobe (shout out to @pyushkevich). The shading and region boundaries will, however, be better the more detailed the mesh is.

<table>
  <tr>
    <td><img src="man/figures/mtl_selection.png" width="400" alt="Medial temporal lobe surface in the interactive view selector"></td>
    <td><img src="man/figures/mtl_rendering.png" width="400" alt="Medial temporal lobe rendered as a 2D atlas"></td>
  </tr>
</table>
...
- [Plotting ggbrat atlases](articles/plotting-atlases.html)
- [Resources and caching](articles/resources-and-caching.html)
- [Building surface atlases](articles/building-surface-atlases.html)
- [Building volumetric atlases](articles/building-volume-atlases.html)
- [Building SVG atlases](articles/building-svg-atlases.html)
- [Using TemplateFlow](articles/templateflow.html)
...
should be available for each resource and you can find them by browsing:
